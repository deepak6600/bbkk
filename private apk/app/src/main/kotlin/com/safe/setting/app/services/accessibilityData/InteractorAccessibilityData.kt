        ...
        if (currentTime - lastLocationUpdate >= locationUpdateInterval) {
            ...
            if (firebase.getUser() != null) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                    ...
                    // ================== सुधार 4: संभावित क्रैश से बचने के लिए try-catch जोड़ा गया ==================
                    // हिंदी कमेंट: पुराने एंड्रॉइड संस्करणों पर getFromLocation क्रैश हो सकता है यदि कोई पता न मिले।
                    // इसलिए, इसे सुरक्षित बनाने के लिए try-catch ब्लॉक में रखा गया है।
                    address = try {
